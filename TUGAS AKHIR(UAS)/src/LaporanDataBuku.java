        ...
        if (i == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                for (CSVRecord csvRecord : csvParser) {
                    ...
                    d.setIsbn(csvRecord.get(1));
                    d.setJudul(csvRecord.get(2));
                    d.setNamakategori(csvRecord.get(3));
                    d.setPengarang(csvRecord.get(4));
                    d.setPenerbit(csvRecord.get(5));
                    d.setTahunterbit(csvRecord.get(6));
                    d.setJumlahhalaman(csvRecord.get(7));
                    d.setJumlahbuku(csvRecord.get(8));
            ...
            String queryString = "SELECT d FROM DataBuku d WHERE ";
             ...
             switch (jComboBox1.getSelectedIndex()) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    queryString += "LOWER(d.namakategori) LIKE LOWER(:searchTerm)";
                    break;
                case 3:
                    queryString += "LOWER(d.pengarang) LIKE LOWER(:searchTerm)";
                    break;
