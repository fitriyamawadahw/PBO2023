...
public class PeminjamanBuku extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 480, 200, 50));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField6.setText(tanggalPinjam);

        String tanggalkembali = jTable1.getValueAt(baris, 8).toString();
        jTextField7.setText(tanggalkembali);
    ...
    private void jTextField2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyTyped
        ...
        searchField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            private void performSearch() {
                ...
                try {
                    em.getTransaction().begin();
                    Query query = em.createQuery("SELECT d.isbn FROM DataBuku d WHERE d.isbn LIKE :input");
    ...
    TypedQuery<Object[]> query = em.createQuery(
        "SELECT p.isbn, COUNT(p.isbn) AS jumlahPeminjam FROM Peminjaman p "
        + "GROUP BY p.isbn ORDER BY COUNT(p.isbn) DESC", Object[].class);

    query.setMaxResults(1); // Ambil satu baris pertama dengan jumlah paling banyak
    ...
    String isbn = String.valueOf(result[0]);
    String jumlahPeminjam = String.valueOf(result[1]);

    System.out.println("ISBN dengan Jumlah Peminjam Terbanyak: " + isbn);
    System.out.println("Jumlah Peminjam: " + jumlahPeminjam);
    
     

    // Load the JasperReports design file
    InputStream inputStream = Peminjaman.class.getResourceAsStream("report4.jrxml");
    JasperDesign jasperDesign = JRXmlLoader.load(inputStream);
    JasperReport jasperReport = JasperCompileManager.compileReport(jasperDesign);
    ...
    parameters.put("jumlahPeminjam", jumlahPeminjam);
